...
### Step 4. Estimation of selection gradients, standard errors and credible intervals using MCMC
...
plot(new.z1, pred.z1$fit, type = "n", xlab = "Standardised fruit crop size", 
ylab = "Absolute fitness (number of fruits pecked)")
polygon(x = c(new.z1, rev(new.z1)),
        y = c(z1.low, rev(z1.upp)),
        lty = 0, col = "#fff7ec")
lines(new.z1, pred.z1$fit, lwd = 3,col = "darkorchid")
...
points(semiurban$z2, semiurban$z3, pch = 19, cex = 2)
...
surface(m_diamxseed, xlab = "Standardised mean fruit diameter",
        ylab = "Standardised mean seed number", extrap = FALSE)
points(rural$z2, rural$z3, pch = 19, cex = 2)
```
...
permutest(betadisper(birds_dist, birds$idpopulation), pairwise = TRUE) 
